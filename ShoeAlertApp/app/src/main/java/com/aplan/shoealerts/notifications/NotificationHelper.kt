...
class NotificationHelper @Inject constructor(
    ...
    fun notifyPriceDrop(deal: Deal, threshold: Double) {
        ...
        val pendingIntent = PendingIntent.getActivity(
            context, (deal.id + 10000).toInt(), intent,
            PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
        )
    ...
    fun notifySearchSummary(newDealCount: Int, underThresholdCount: Int) {
        ...
        val pendingIntent = PendingIntent.getActivity(
            context, NOTIF_ID_SUMMARY, intent,
            PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
        )
        ...
        val body = buildString {
            ...
            if (underThresholdCount > 0) {
                append(", $underThresholdCount under your price threshold!")
            }
        }
